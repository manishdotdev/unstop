...
// Import data at module level for immediate access
...
export const UserProvider = ({ children }) => {
  ...
  const [applications, setApplications] = useState([...applicationsHistory]);
  ...
  const addApplication = (applicationData) => {
    ...
    const newApp = {
      ...
      logo: logoMap[applicationData.position.company] || "https://via.placeholder.com/40",
  ...
  return (
    <UserContext.Provider value={{ userData, loading: false, loadUserData, applications, addApplication }}>
      {children}
